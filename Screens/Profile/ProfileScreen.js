...
import { View, Text, StyleSheet, TextInput, Button, Alert, Image, TouchableOpacity, ScrollView } from 'react-native';
...
const ProfileScreen = () => {
  ...
  const [profileImage, setProfileImage] = useState('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwdIVSqaMsmZyDbr9mDPk06Nss404fosHjLg&s'); // Replace with actual image URL
    ...
    <View style={styles.screenContainer}>
      ...
      <View style={styles.buttonContainer}>
        <View style={styles.buttonWrapper}>
          <Button title="Edit Profile" onPress={handleEditProfile} color="rgb(174,12,46)" />
        </View>
        <View style={styles.buttonWrapper}>
