...
const PaymentScreen = ({ route }) => {
    ...
    const handlePlaceOrder = () => {
        ...
        // Navigate to a confirmation screen or reset the state as needed
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity 
                style={[styles.paymentMethod, paymentMethod === 'gcash' && styles.selectedPaymentMethod]} 
            ...
            <TouchableOpacity 
                style={[styles.paymentMethod, paymentMethod === 'counter' && styles.selectedPaymentMethod]} 
            ...
            {paymentMethod === 'gcash' && (
                <View style={styles.imagePickerContainer}>
                    <TouchableOpacity style={styles.imagePicker} onPress={pickImage}>
                        {paymentScreenshot ? (
                            <Image source={{ uri: paymentScreenshot }} style={styles.image} />
                        ) : (
                            <Text style={styles.imagePlaceholder}>Upload Payment Screenshot</Text>
                        )}
                    </TouchableOpacity>
                </View>
            )}
