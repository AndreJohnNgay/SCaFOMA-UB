...
function Customers() {
    ...
    const [deleteModalOpen,
        setDeleteModalOpen] = useState(false);
    const [editingCustomer,
        setEditingCustomer] = useState(null);
    const [customerToDelete,
        setCustomerToDelete] = useState(null);

    const filteredCustomers = customerData.filter(customer => customer.name.toLowerCase().includes(searchTerm.toLowerCase()));
            ...
            {deleteModalOpen && (
                <div
                    ...
                    <div className="bg-white p-6 rounded shadow-lg">
                        ...
                        <p>Are you sure you want to delete {customerToDelete
                                ?.name}?</p>
                        <div className="flex justify-end">
                            <button
