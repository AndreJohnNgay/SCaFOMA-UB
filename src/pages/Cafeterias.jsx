...
function Cafeterias() {
    ...
    const [cafeteriaToDelete, setCafeteriaToDelete] = useState(null); // Cafeteria to be deleted
    ...
    const handleDeleteCafeteria = () => {
        console.log(`Deleted cafeteria: ${cafeteriaToDelete.name}`);
        // Here you can handle actual deletion logic, like updating state or making an API call
                                    ...
                                    <td className="border-t py-2 px-4 flex space-x-2">
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                setCafeteriaToDelete(cafeteria); // Set the cafeteria to be deleted
                                            }}
                                            className="bg-red-950 text-white px-4 py-2 rounded hover:bg-red-600 flex items-center"
                                        >
                        ...
                        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded shadow-lg">
                                <h2 className="text-lg font-semibold mb-4">
                                    {isEditing ? 'Edit Cafeteria' : 'Add Cafeteria'}
                                </h2>
                                <input
                                    type="text"
                    ...
                    {deleteModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded shadow-lg">
                                ...
                                <p>Are you sure you want to delete {cafeteriaToDelete?.name}?</p>
