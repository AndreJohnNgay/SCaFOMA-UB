...
const concessionData = [
  { id: 1, concessionName: 'Concession A', assignedDate: '2023-09-15' },
  { id: 2, concessionName: 'Concession B', assignedDate: '2023-09-16' },
  { id: 3, concessionName: 'Concession C', assignedDate: '2023-09-17' },
  { id: 4, concessionName: 'Concession D', assignedDate: '2023-09-18' },
  { id: 5, concessionName: 'Concession E', assignedDate: '2023-09-19' },
  { id: 6, concessionName: 'Concession F', assignedDate: '2023-09-20' },
  { id: 7, concessionName: 'Concession G', assignedDate: '2023-09-21' },
  { id: 8, concessionName: 'Concession H', assignedDate: '2023-09-22' },
  { id: 9, concessionName: 'Concession I', assignedDate: '2023-09-23' },
  { id: 10, concessionName: 'Concession J', assignedDate: '2023-09-24' },
  { id: 11, concessionName: 'Concession K', assignedDate: '2023-09-25' },
  { id: 12, concessionName: 'Concession L', assignedDate: '2023-09-26' },
];
...
function ViewCafeteria() {
  ...
  // Filter concessions based on the search term
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <p><strong>Location:</strong> {cafeteria.location}</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mt-4 flex justify-between items-center">
              ...
              <span className="text-gray-600">Showing {currentRows.length} of {filteredConcessions.length}</span>
            </div>
          </div>
        </div>
      </div>
