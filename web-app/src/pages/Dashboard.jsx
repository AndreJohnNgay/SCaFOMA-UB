...
const ordersData = [
    {
        id: '#1234',
        customer: 'John Doe',
        concessionaire: "J's Shawarma",
        total: '₱45.67',
        status: 'Completed'
    }, {
        id: '#1235',
        customer: 'Jane Smith',
        concessionaire: 'Mang Juan',
        total: '₱67.89',
        status: 'Pending'
    }, {
        id: '#1236',
        customer: 'Alice Johnson',
        concessionaire: 'K-BBQ',
        total: '₱34.56',
        status: 'Completed'
    }, {
        id: '#1237',
        customer: 'Bob Brown',
        concessionaire: 'Pizza Hut',
        total: '₱23.45',
        status: 'Pending'
    }, {
        id: '#1238',
        customer: 'Charlie Green',
        concessionaire: 'Burger King',
        total: '₱89.99',
        status: 'Completed'
    }, {
        id: '#1239',
        customer: 'Dave White',
        concessionaire: 'Starbucks',
        total: '₱54.23',
        status: 'Pending'
    }, {
        id: '#1240',
        ...
        id: '#1241',
        customer: 'Frank Blue',
        concessionaire: 'Jollibee',
        total: '₱98.76',
        status: 'Completed'
    }, {
        id: '#1242',
        customer: 'Grace Red',
        concessionaire: 'McDonald\'s',
        total: '₱43.21',
        status: 'Pending'
    }, {
        id: '#1243',
        customer: 'Harry Yellow',
        concessionaire: 'Dunkin',
        total: '₱12.34',
        status: 'Completed'
    }, {
        id: '#1244',
        customer: 'Ivy Purple',
        concessionaire: 'Subway',
        total: '₱76.54',
        status: 'Pending'
    }
];
                                ...
                                <tbody>
                                    {currentRows.map((order, index) => (
                                        <tr key={index}>
                                            ...
                                            <td
                                                className={`border-t py-2 px-4 ${order.status === 'Completed'
                                                ? 'text-green-500'
                                                : 'text-yellow-500'}`}>
                                                {order.status}
                                            </td>
